...
from omniglot_loader import OmniglotLoader, DatasetLoader, DatasetWithSubClassesLoader
import time
...
def main():
    ...
    model_name = f'siamese_net_lr10e-4_{int(time.time())}'
    tensorboard_log_path = f'./logs/siamese_net_lr10e-4_{model_name}'
    loader = DatasetWithSubClassesLoader(dataset_path=dataset_path, 
    ...
    momentum_slope = 0.01
    support_set_size = 20
    evaluate_each = 100#1000
    number_of_train_iterations = 20000#1000000
