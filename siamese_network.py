...
class SiameseNetwork:
    ...
    def __init__(self, loader, learning_rate,
    ...
    def _construct_siamese_architecture(self, learning_rate_multipliers,
        ...
        #    momentum=0.5)
        optimizer = Adam(self.learning_rate) #Adam(0.00006)
        ...
        for iteration in range(number_of_iterations):
            ...
            if (iteration + 1) % evaluate_each == 0:
                ...
                validation_accuracy = self.omniglot_loader.one_shot_test(
                    self.model, support_set_size, number_of_runs, is_validation=True)
